...
describe('CategoryController', () => {
  ...
  describe('findAll', () => {
    it('should return an array of categories', async () => {
      const categories: any[] = [
        { id: 1, name: 'Category1', description: 'description kiriting' },
      ];
  ...
  describe('create', () => {
    it('should create a new category', async () => {
      const category = { id: '1', name: 'New Category', description: "Nimadr" };
      const createCategoryDto = { name: 'New Category', description: 'Nimadr' };
